...
Original file is located at
    https://colab.research.google.com/drive/12xJ8Cb5BzTqbnhiT9fV7W_BAJshw1ZGQ
"""
...
print(input_column_numeric)
print(input_column_numeric.dtype)
print(input_column_numeric.shape)
...
print(output_column_numeric)
print(output_column_numeric.dtype)
print(output_column_numeric.shape)
...
plt.savefig("2023_RNN.jpeg", dpi=300, bbox_inches='tight')
plt.show()
...
# Save the figure in PDF format with DPI 300 and tight layout
plt.savefig("2023_RNN_input.jpeg", dpi=300, bbox_inches='tight')
plt.show()
